            ...
            <div class="u_container">
                <div id="footer_content" class="footer_content">
                    <div class="footer_logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/logo_footer.png" alt="" class="footer_logo_img">
                    </div><!-- /.footer_logo -->
                    ...
                    <div class="footer_menu">
                        <nav class="footer_nav text_s">
                            <ul class="footer_nav_list">
                                <li class="footer_nav_item">
                                    <a href="/about/" class="footer_nav_link">道場について</a><!-- /.footer_nav_link -->
                                </li><!-- /.footer_nav_item -->
                                <li class="footer_nav_item">
                                    <a href="/recruit/" class="footer_nav_link">道場生募集</a><!-- /.footer_nav_link -->
                                </li><!-- /.footer_mav_item -->
                                <li class="footer_nav_item">
                                    <a href="/tournament/" class="footer_nav_link">大会予定</a><!-- /.footer_nav_link -->
                                </li><!-- /.footer_nav_item -->
                                <li class="footer_nav_item">
                                    <a href="/notice/" class="footer_nav_link">お知らせ</a><!-- /.footer_nav_link -->
                                </li><!-- /.footer_nav_item -->
                                <li class="footer_nav_item">
                                    <a href="/contact/" class="footer_nav_link">お問い合わせ</a><!-- /.footer_nav_link -->
                                </li><!-- /.footer_nav_item -->
                            </ul><!-- /.footer_nav_list -->
                        </nav><!-- /.footer_nav -->
                    </div><!-- /.footer_menu -->
                    <div class="footer_meta">
                        <div class="sns">
                            <ul class="sns_list">
                                <li class="sns_item">
                                    <a href="" class="sns_button sns_button_x">
                                        <span class="sns_icon sns_icon_x">
                                        ...
                                        </span><!-- /.sns_icon.sns_icon_x -->
                                    </a><!-- /.sns_button.sns_button_x -->
                                </li><!-- /.sns_item -->
                                <li class="sns_item">
                                    <a href="https://www.instagram.com/narashinken/" class="sns_button sns_button_instagram">
                                        <span class="sns_icon sns_icon_instagram">
                                        ...
                                        </span><!-- /.sns_icon.sns_icon_instagram -->
                                    </a><!-- /.sns_button.sns_button_instagram -->
                                </li><!-- /.sns_item -->
                                <li class="sns_item">
                                    <a href="" class="sns_button sns_button_youtube">
                                        <span class="sns_icon sns_icon_youtube">
                                            <svg width="100%" viewbox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        ...
                                        </span><!-- /.sns_icon.sns_icon_youtube -->
                                    </a><!-- /.sns_button.sns_button_youtube -->
                                </li><!-- /.sns_item -->
                                <li class="sns_item">
                                    <a href="" class="sns_button sns_button_facebook">
                                        <span class="sns_icon sns_icon_facebook">
                                        ...
                                        </span><!-- /.sns_icon.sns_icon_facebook -->
                                    </a><!-- /.sns_button.sns_button_facebook -->
                                </li><!-- /.sns_item -->
                            </ul><!-- /.sns_list -->
                        </div><!-- /.sns -->
                        <p class="footer_copy text_s">
                            © 2024 NaraShinkenDojo
                        </p><!-- /.footer_copy text_s -->
                    </div><!-- /.footer_meta -->
                </div><!-- /#footer_content.footer_content -->
            </div><!-- /.u_container -->
            <div class="footer_spacing">
                <span class="footer_spacing_gradation"></span><!-- /.footer_spacing_gradation -->
            </div><!-- /.footer_spacing -->
        </footer><!-- /#footer.footer -->
    </div><!-- /#body_container.body_container -->
<?php wp_footer(); ?>
</body>
</html>