                    ...
                    <div class="main_col">
                        ...
                        <div class="single_wrapper">
                            <div class="single_header">
                                <h3 class="single_title text_xl">
                                    <?php the_title(); ?>
                                </h3><!-- /.single_title.text_xl -->
                                <div class="single_data">
                                    <li class="tag_wrapper single_tag_wrapper">
                                        <?php 
                                            $tags = get_the_tags();
                                            if(!empty($tags)) {
                                                foreach ($tags as $tag) {
                                                ...
                                                echo "<p class='tag'>タグなし</p>";
                                            }
                                        ?>
                                    </li><!-- /.tag_wrapper.single_tag_wrapper -->
                                    <div class="date_wrapper single_date_wrapper">
                                    ...
                                    </div><!-- /.date_wrapper.single_date_wrapper -->
                                </div><!-- /.single_data -->
